...
II) It is allowed to distribute a modified (or extended) version of {project},
    ...
    2) The modified {project} must be distributed in one of the following five ways:
       a) If you make changes to {project} yourself, you must clearly describe in
	  ...
	  making their own changes to the official version of {project}.
       d) When you have a modified {project} which includes changes as mentioned
...
III) If you distribute a modified version of {project}, you are encouraged to use
